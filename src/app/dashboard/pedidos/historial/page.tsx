    ...
    <div className="p-4 sm:p-6 pb-24 md:pb-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div className="flex items-center gap-3">
          <Link href="/dashboard/pedidos" className="p-2 hover:bg-gray-100 rounded-full transition-colors text-gray-600">
            <ArrowLeft size={24} />
          </Link>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Historial de Pedidos</h1>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {(!pedidos || pedidos.length === 0) && (
          <div className="col-span-full bg-gray-50 rounded-3xl p-12 text-center text-gray-500 flex flex-col items-center justify-center border-2 border-dashed border-gray-200">
            ...
            <p className="font-medium text-lg text-gray-800">No hay pedidos en el historial.</p>
          </div>
        )}
      </div>
    </div>
