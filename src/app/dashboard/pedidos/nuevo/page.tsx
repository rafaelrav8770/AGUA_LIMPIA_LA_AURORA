...
export default function NuevoPedidoPage() {
  ...
  const setToday = () => {
    ...
    // Ajustar por zona horaria local para evitar problemas con UTC
  ...
  return (
    <div className="p-4 sm:p-6 max-w-2xl mx-auto w-full">
      <div className="flex items-center gap-3 sm:gap-4 mb-6">
        ...
        <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Nuevo Pedido</h1>
      </div>

      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-5 sm:p-8">
        <form action={createOrder} className="space-y-6 sm:space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold text-gray-700 ml-1 flex justify-between items-center mb-1">
                <span>Fecha</span>
              ...
              <input 
                ...
                className="w-full rounded-2xl border border-gray-200 px-4 py-3.5 sm:py-3 bg-gray-50 focus:bg-white focus:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-500/10 transition-all font-medium text-gray-800" 
              />
            </div>
